...
export function OrcamentosPage() {
  ...
  const totais = useMemo(() => {
    ...
    const realizadoTotal = orcamentosAba.reduce((s, o) => s + o.gasto, 0);

    const comprometidoTotal = orcamentosAba.reduce((s, o) => s + o.comprometido, 0);

    const previstoTotal = orcamentosAba.reduce((s, o) => s + o.total_usado, 0);
          ...
          <div className="app-card p-5">
            ...
            <p
              ...
              className={`mt-2 text-right text-xs ${
                ...
                totais.alerta ? "font-medium text-rose-400" : "text-slate-500"
              ...
              <div key={orc.id} className="app-card p-5">
                ...
                <div className="mb-3 flex items-start justify-between">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-slate-100">{tituloOrcamento(orc, cat)}</p>
                    ...
                    {orc.recorrente_id && (
                      ...
                      <span className="mt-1 inline-block rounded bg-cyan-500/15 px-2 py-0.5 text-xs font-medium text-cyan-300 ring-1 ring-cyan-500/30">
                ...
                <p
                  ...
                  className={`mt-1 text-right text-xs ${
                    ...
                    alertaItem ? "font-medium text-rose-400" : "text-slate-500"
...
function ResumoCard({
  ...
  const colors = {
    ...
    indigo: "border-cyan-500/20 bg-cyan-500/10 text-cyan-200",
    ...
    >
      ...
      <form onSubmit={(e) => void handleSubmit(e)} className="space-y-4">
        ...
        {!orcamento && (
          ...
          <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-white/10 bg-white/5 p-3">
            ...
            <div>
              ...
              <span className="text-sm font-medium text-slate-200">Repetir todo mês</span>
        ...
        {orcamento?.recorrente_id && (
          ...
          <label className="flex cursor-pointer items-start gap-3 rounded-lg border border-cyan-500/20 bg-cyan-500/10 p-3">
            ...
            <div>
              ...
              <span className="text-sm font-medium text-cyan-200">Atualizar todos os meses</span>
        ...
        {(valorLimite || orcamentosMes.length > 0) && (
          ...
          <div className="app-muted-box px-3 py-3 text-sm text-slate-300">
